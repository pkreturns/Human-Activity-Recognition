...
SMA_mean = mean(SMA);
Mean_mean = mean(Mean,1);
RMS_mean = mean(RMS);
Pt_80_mean = mean(Pt_80);
Standev_mean = mean(Standev,1);
Pt_50_mean = mean(Pt_50);
Median_mean = mean(Median,1);
Range_mean = mean(Range,1);
Pt_90_mean = mean(Pt_90);
Pt_20_mean = mean(Pt_20);

pack = {SMA_mean, Mean_mean(4),RMS_mean,Pt_80_mean,Standev_mean(3),Pt_50_mean,Median_mean(4),Range_mean(3),Pt_90_mean,Pt_20_mean};
